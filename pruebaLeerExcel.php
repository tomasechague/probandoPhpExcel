...
for ($i = 2; $i <= $highestRow + 1; $i++) {
    ...
    if (isset($obj->results[0])) {
        $objPHPExcel->getActiveSheet()->setCellValue('L' . $i, isset($obj->address_components[0]->long_name) ? $obj->address_components[0]->long_name : '');
        $objPHPExcel->getActiveSheet()->setCellValue('M' . $i, isset($obj->address_components[1]->long_name) ? $obj->address_components[0]->long_name : '');
        $objPHPExcel->getActiveSheet()->setCellValue('N' . $i, isset($obj->address_components[2]->long_name) ? $obj->address_components[0]->long_name : '');
        $objPHPExcel->getActiveSheet()->setCellValue('O' . $i, isset($obj->address_components[3]->long_name) ? $obj->address_components[0]->long_name : '');
        $objPHPExcel->getActiveSheet()->setCellValue('P' . $i, isset($obj->address_components[4]->long_name) ? $obj->address_components[0]->long_name : '');
        $objPHPExcel->getActiveSheet()->setCellValue('Q' . $i, isset($obj->address_components[5]->long_name) ? $obj->address_components[0]->long_name : '');
        $objPHPExcel->getActiveSheet()->setCellValue('R' . $i, isset($obj->address_components[6]->long_name) ? $obj->address_components[0]->long_name : '');
...
header('Content-Disposition: attachment;filename="PadronCaja.xlsx"');
